...
# ommit time_end and the date of today will be used
# add start time as one year ago (calculated)
year_ago = datetime.now() - timedelta(days=365)
year_ago_timestamp = year_ago.isoformat()
now_timestamp = datetime.now().isoformat()

url = "https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical"
param = {"convert": "USD", "slug": "bitcoin", "time_end": str(now_timestamp), "time_start": str(year_ago_timestamp)}
...
plt.xticks(predictions.index, rotation=75)
plt.legend()
plt.show()
